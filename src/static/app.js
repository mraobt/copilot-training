          ...
          ? `<ul class="participants-list">
              ${details.participants.map(participant => `
                <li>
                  ...
                  <button type="button" class="remove-participant-button" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}" aria-label="Remove ${participant}">✕</button>
                </li>
              `).join('')}
            </ul>`
